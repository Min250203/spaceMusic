...
function InforSingleTrack({ dataInfor,typeListSong }) {
        ...
        <>
            <div class="container__infor_tracks-playing" style={{ display: openInforSingle === false ? "none" : "block" }}>
                <div class="content__infor_tracks-playing">
                    <div className='wrap__content_infor'>
                        <div class="infor__tracks_single-playing">
                            <div class="headtitle__tracks-playing">
                                <div class="name__album_tracks-playing">{dataInfor.hasOwnProperty('album') ? dataInfor.album.title : dataInfor.title}</div>
                                <FaTimes onClick={() => { setOpenInforSingle(false) }} />
                            </div>

                            <div class="img__album_tracks-playing">
                                <img class="img__album-playing" src={dataInfor.artists ? dataInfor.thumbnailM : ''} alt="" />
                            </div>
                            <div class="tool__tracks-playing">
                                <div class="title__tracks-playing">
                                    <div class="name__sing_tracks-playing">{dataInfor.artists ? dataInfor.title : ''}</div>
                                    <div class="name__artist-tracks-playing">{dataInfor.artists ? dataInfor.artistsNames : ''}</div>
                                </div>
                            ...
                            <div class="infor__artist-playing">
                                ...
                                <div class="title__artist-playing">
                                    <div class="name__artist-playing">
                                        <div class="name__artist-playing">{dataInfor.artists ? dataInfor.artistsNames : ''}</div>
                                ...
                                <div class="name__album_artist-playing">{dataInfor.hasOwnProperty('album')  ? dataInfor.album.title : ''}</div>
                            </div>
                        </div>
